...
- [ ] T004 [US1] Add fail-closed policy evaluation and focused Qwen-shaped-but-generic authorization tests in `internal/participant/policy.go`, `internal/participant/policy_test.go`, and `internal/participant/types.go`
